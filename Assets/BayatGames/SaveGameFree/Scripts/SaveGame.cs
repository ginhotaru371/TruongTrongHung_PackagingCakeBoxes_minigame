...
namespace BayatGames.SaveGameFree
{
    ...
    public static class SaveGame
    {
        ...
        /// <typeparam name="T">The 1st type parameter.</typeparam>
        public static void Save<T>(string identifier, T obj, bool encode, ISaveGameSerializer serializer, SaveGamePath path)
        {
            Save<T>(identifier, obj, encode, EncodePassword, serializer, Encoder, DefaultEncoding, path);
        }
        ...
        /// <param name="path">Path.</param>
        /// <typeparam name="T">The 1st type parameter.</typeparam>
        public static T Load<T>(string identifier, T defaultValue, bool encode, ISaveGameSerializer serializer, SaveGamePath path)
        {
            return Load<T>(identifier, defaultValue, encode, EncodePassword, serializer, Encoder, DefaultEncoding, path);
        }
